...
![Machine Learning](https://img.shields.io/badge/Machine%20Learning-Vis%C3%A3o%20Computacional-green)
...
<!-- Animated Header -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f172a,50:1a56db,100:10b981&height=220&section=header&text=Vis%C3%A3o%20Computacional%20-%20Atividades&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Capacita%C3%A7%C3%A3o%20em%20Processamento%20de%20Imagens&descSize=18&descAlignY=55&descColor=94a3b8" width="100%" alt="Visão Computacional Header"/>
</p>
...
6. **[OPCIONAL] - Análise Crítica: Fundamentos de Imagens Digitais Unidade 1 | Capítulo 1 | Tarefa 1**
   - Análise teórica aprofundada sobre fundamentos de imagens digitais
   - Aplicação a cenários reais de visão computacional

7. **[OPCIONAL] - Análise de Imagens no Domínio da Frequência - Unidade 2 | Capítulo 1 | Tarefa 2**
   - Compreensão da Transformada de Fourier
   - Análise de filtros passa-baixa, passa-alta e passa-banda

8. **[OPCIONAL] - Atividade de Segmentação, Operação Morfológica e Extração de Características - Unidade 3 | Capítulo 1**
   - Análise conceitual das etapas do pipeline de visão computacional
   - Aplicação a cenários industriais

9. **[OPCIONAL] - Experimentos de Visão Computacional no Kaggle - Unidade 03 | Capítulo 2**
